...
/// Indicates that the type is the [`Trader`](crate::interface::trader::Trader)-to-itself message.
...
/// Indicates that the type is the [`Broker`](crate::interface::broker::Broker)-to-itself message.
